...
export default function NewCustomer() {
    ...
    return (_jsx(Layout, { children: _jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [_jsx(PageHeader, { title: t.customer.add, backButton: true, backButtonText: t.common.back, backButtonLink: "/customers" }), _jsx("div", { className: "mt-8", children: _jsx(CustomerForm, { formData: formData, onChange: handleChange, onSubmit: handleSubmit, onPaste: handlePaste }) })] }) }));
}
